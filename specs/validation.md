...
| TC-077 | For every tracked governed file, verify the first valid header is `SPDX-License-Identifier: MIT` with the correct comment syntax and no governed file is missing the identifier. |
